...
const showCarAnimation = () => {
  const noAnimationRoutes = ['/ridelist', '/myrides', '/settings'];
  return !noAnimationRoutes.includes(route.path);
};
</script>
